...
- [ ] **License decided** — `apps/aristotle-cli/package.json` `license` is correct for publication (currently `UNLICENSED`; set a real license before a public `npm publish`)
