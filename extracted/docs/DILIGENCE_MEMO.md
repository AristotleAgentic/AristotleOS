...
License: split licensing; substrate material is BUSL-1.1, adapter packages are Apache-2.0, root docs are CC-BY-4.0, and third-party dependencies remain governed by their own licenses. Repository organization: pnpm monorepo, ~47 packages, ~820 test cases.
