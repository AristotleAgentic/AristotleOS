...
License: open-core licensing; AristotleOS source code is MPL-2.0 unless a more specific package states otherwise, some adapter packages are Apache-2.0 where marked, root docs are CC-BY-4.0, and third-party dependencies remain governed by their own licenses. Repository organization: pnpm monorepo, ~47 packages, ~820 test cases.
